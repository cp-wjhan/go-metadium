...
func (s *PersonalAccountAPI) EdPubKey(ctx context.Context, addr common.Address, passwd string) (hexutil.Bytes, error) {
	// Look up the wallet containing the requested signer
	account := accounts.Account{Address: addr}
...
// VRF Prove
func (s *PersonalAccountAPI) Prove(ctx context.Context, addr common.Address, passwd string, msg hexutil.Bytes) (hexutil.Bytes, error) {
	// Look up the wallet containing the requested signer
	account := accounts.Account{Address: addr}
...
// VRF Verify
func (s *PersonalAccountAPI) Verify(ctx context.Context, pk, pi, msg hexutil.Bytes) (bool, error) {
	// Look up the wallet containing the requested signer
