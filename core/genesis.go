...
func SetupGenesisBlockWithOverride(db ethdb.Database, genesis *Genesis, overrideTerminalTotalDifficulty *big.Int, overrideTerminalTotalDifficultyPassed *bool, overrideBokbunja *big.Int) (*params.ChainConfig, common.Hash, error) {
...
func DefaultGenesisBlock() *Genesis {
	...
	if genesis, err = loadDefaultGenesisFile(); err != nil {
		...
		genesis.Config = genesis.configOrDefault(params.MetadiumMainnetGenesisHash) //set MetadiumMainnetChainConfig
		return genesis
	}
}
...
func DefaultTestnetGenesisBlock() *Genesis {
	...
	if genesis, err = loadDefaultGenesisFile(); err != nil {
		...
		genesis.Config = genesis.configOrDefault(params.MetadiumTestnetGenesisHash) //set MetadiumTestnetChainConfig
		return genesis
	}
}
