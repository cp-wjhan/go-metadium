...
var (
	...
	AllEthashProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, nil, nil, false, new(EthashConfig), nil}
	...
	// This configuration is intentionally not using keyed fields to force anyone
	// adding flags to the config to also have to set these fields.
	AllCliqueProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, nil, nil, nil, false, nil, &CliqueConfig{Period: 0, Epoch: 30000}}

	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, nil, nil, nil, false, new(EthashConfig), nil}
...
var NetworkNames = map[string]string{
	...
	MetadiumMainnetChainConfig.ChainID.String(): "metadium mainnet",
	MetadiumTestnetChainConfig.ChainID.String(): "metadium testnet",
}
...
func (c *ChainConfig) String() string {
	...
	case c.Ethash != nil:
		if c.TerminalTotalDifficulty == nil {
			if ConsensusMethod == ConsensusPoW {
				...
				banner += "Consensus: Ethash (Stake base Proof of Authority for metadium)\n"
			}
	...
	default:
		banner += "Consensus: Ethash (default: Stake base Proof of Authority for metadium)\n"
	}
	banner += "\n"
	...
	banner += fmt.Sprintf(" - Avocado:                     %-8v\n", c.AvocadoBlock)
	banner += fmt.Sprintf(" - Pangyo:                      %-8v\n", c.PangyoBlock)
	banner += fmt.Sprintf(" - Applepie:                    %-8v\n", c.ApplepieBlock)
	banner += fmt.Sprintf(" - Bokbunja:                    %-8v\n", c.BokbunjaBlock)
